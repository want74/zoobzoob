<?php $__env->startSection('content'); ?>
    <div class="bg-white rounded-[12px] px-[45px] py-[38px] box-border">
        ...
        <div class="grid grid-cols-2 gap-2 my-4">
            ...
            <input type="" name="num" style="display: none" value="<?php echo e($_GET['zoob_id']); ?>">
            <button class="bg-[#6366F1] rounded-[12px] px-[24px] py-[10px] text-white font-bold text-2xl ml-auto">Отправить</button>
        </form>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts/auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zoobzoob-end\laravel\resources\views/advanced/problem.blade.php ENDPATH**/ ?>