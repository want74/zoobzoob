<p align="center">
  <img
    src="https://readme-typing-svg.herokuapp.com?font=Orbitron&size=40&color=%2379A500&height=67&duration=3000&center=true&lines=Zoob+Zoob">

</p>

### Наш проект

  Наш проект zoobzoob решает проблему не хватки информации про поддержание и лечение полости рта с помощью веб платформы, который имеет функционал курсов, записи к врачу, онлайн-консультации.

### Какой у нас функционал:
- Запись к врачу
- Гайды
- Напоминалки
...
![Laravel](https://img.shields.io/badge/-Laravel-05122A?style=flat&logo=Laravel&logoColor=6E81B6)&nbsp;
